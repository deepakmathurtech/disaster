...
exports.SimulatedTrafficProvider = void 0;
class SimulatedTrafficProvider {
    entitiesMap;
    constructor(entitiesMap) {
        this.entitiesMap = entitiesMap;
    }
    evaluateEdge(edgeId, roadName, distanceKm, baseSpeedKmh, entityId) {
        let stateMultiplier = 1.0;
        let trafficLevel = 'low';
        let safetyCondition = 'safe';
...
exports.SimulatedTrafficProvider = SimulatedTrafficProvider;
